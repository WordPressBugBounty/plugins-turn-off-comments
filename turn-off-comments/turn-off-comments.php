...
/**
 * MM Comment Manager is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * MM Comment Manager is distributed in the hope that it will be useful,
...
add_action( 'wp_dashboard_setup', 'turn_off_comments_dashboard' );
...
add_action( 'wp_enqueue_scripts', 'turn_off_comments_hide_comment_styles' );
